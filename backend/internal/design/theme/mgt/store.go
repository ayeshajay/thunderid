...
func (s *themeMgtStore) GetThemeListCount(ctx context.Context) (int, error) {
	...
	countResults, err := dbClient.QueryContext(ctx, queryGetThemeListCount, s.scope(ctx))
	if err != nil {
...
func (s *themeMgtStore) GetThemeList(ctx context.Context, limit, offset int) ([]Theme, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetThemeList, limit, offset, s.scope(ctx))
	if err != nil {
...
func (s *themeMgtStore) GetTheme(ctx context.Context, id string) (Theme, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryGetThemeByID, id, s.scope(ctx))
	if err != nil {
...
func (s *themeMgtStore) IsThemeExist(ctx context.Context, id string) (bool, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryCheckThemeExists, id, s.scope(ctx))
	if err != nil {
...
func (s *themeMgtStore) DeleteTheme(ctx context.Context, id string) error {
	...
	_, err = dbClient.ExecuteContext(ctx, queryDeleteTheme, id, s.scope(ctx))
	if err != nil {
		return fmt.Errorf("failed to execute query: %w", err)
	}
...
func (s *themeMgtStore) IsThemeHandleConflict(ctx context.Context, handle string, excludeID string) (bool, error) {
	...
	results, err := dbClient.QueryContext(ctx, queryCheckThemeHandleConflict, handle, s.scope(ctx), excludeID)
	if err != nil {
