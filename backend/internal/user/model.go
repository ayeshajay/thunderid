...
// is going to refuse.
func entityToUserForContext(ctx context.Context, e *providers.Entity) providers.User {
	user := entityToUser(e)
...
func entitiesToUsersForContext(ctx context.Context, entities []providers.Entity) []providers.User {
